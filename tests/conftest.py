...
def tmp_storage(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("expense_cli.identifier._LEGACY_CATEGORIES_PATH", tmp_path / "categories.toml")
    monkeypatch.setattr("expense_cli.categorizer.COUNTERPARTIES_PATH", tmp_path / "counterparties.toml")
